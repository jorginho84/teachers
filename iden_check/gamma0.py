...
ax.legend()
ax.set_ylabel(r'% of "expert" teachers',fontsize=font_size)
ax.set_xlabel(r'Utility loss from effort type 1',fontsize=font_size)
...
ax.legend(loc=0)
plt.show()
fig.savefig('/Users/jorge-home/Dropbox/Research/teachers-reform/codes/teachers/iden_check/gamma0.pdf', format='pdf')
plt.close()
